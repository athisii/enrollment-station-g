...
public class SlapScannerController_191022 implements Initializable {
    ...
    public SlapScannerController_191022() {
            ...
            try {
                ...
                if (leftfingerstoscan() >= 1) {    //Enable For Single Fingerprint Capture
                    ...
                    try {
                        ...
                        Logger.getLogger(SlapScannerController_191022.class.getName()).log(Level.SEVERE, null, ex);
                    }
                ...
                if (fingerstoscanthumb >= 1 && fingerstoscanthumb <= 2) {
                    ...
                    Platform.runLater(new Runnable() {
                        ...
                        public void run() {
                            ...
                            LOGGER.log(Level.INFO, "capture size thumb :" + captureModesCompleted.size());
                            if (captureModesCompleted.size() == 3) {
                                showIrisBtn.setDisable(false);
                                //scan.setDisable(true);
                                scan.setDisable(false);
                    ...
                    Platform.runLater(new Runnable() {
                        ...
                        public void run() {
                            ...
                            statusField.setText("Fingers capture not required, proceed next to Capture IRIS");
                            scan.setDisable(false);
                            showIrisBtn.setDisable(false);
                            if (captureModesCompleted.contains(3)) {
                                captureModesCompleted.remove(3);
                    ...
                    //statusField.setText("Thumbs capture Not required");
...
//                    icon.setImage(bufferedImage, qty, x, y, r);
    ...
    public String sequenceCheckProcess2(RealScan_JNI.RSImageInfo[] imageInfo, int numOfFingers, String finger) {
        ...
        if (!bIsMatched)
            retString = "There isn't matched finger"; //If they are placing fingers are not unique
    ...
    public String leftFingersToScan(List<String> missingFingers) {
        ...
        if (fingerstoscan.equals(""))
            return "four";
        else
            return fingerstoscan.toString();
