...
// * @author boss
// */
//public class ARCNoControllerOld implements Initializable {
//
...
//                                    App.setRoot("iris");
//                                } catch (IOException ex) {
//                                    Logger.getLogger(ARCNoControllerOld.class.getName()).log(Level.SEVERE, null, ex);
...
//
//                //added for ARCnumber is empty
//                if (arcDetails.getArcNo().isEmpty() || arcDetails.getArcNo() == null) {
//                    lblStatus.setText("ARC No is Empty Cannot Proceed");
//                    return;
//                }
