...
//
//
//public class FetchLabourdetailscontroller_270522 implements Initializable, MIDFingerAuth_Callback {
//
//    @FXML
...
//
//    public FetchLabourdetailscontroller_270522() {
//
//        //MIDfinger
...
//                Logger.getLogger(FetchLabourdetailscontroller_270522.class.getName()).log(Level.SEVERE, null, ex);
...
//                    int ret = midFingerAuth.MatchTemplate(fingerData, Base64.getDecoder().decode(labour.get(k).getFpData()), matchScore, TemplateFormat.FMR_V2011);
//
//                    if (ret < 0) {
...
//
//
//            /*System.out.println("Size of finger prints"+labourFpLists.get(j).getfPs().size());
//
//            System.out.println("labour details "+labourFpLists.get(j).getDynamicFileList().get(0).getLabourId());
//            int dynamicfilelistsize = labourFpLists.get(j).getDynamicFileList().size();
//            System.out.println("dynamicfilelistsize"+dynamicfilelistsize);
//
//
