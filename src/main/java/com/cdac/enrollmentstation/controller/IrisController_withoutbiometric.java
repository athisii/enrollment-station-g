...
// * @author boss
// */
//public class IrisController_withoutbiometric implements MIDIrisEnrollCallback, Initializable {
...
//    Handler handler;
//
//    public IrisController_withoutbiometric() {
//
...
//          /*
//        if(holder.getARC().getBiometricoptions().contains("Biometric")){
//                try {
//                     mIDIrisEnroll.Uninit();
