...
//        System.out.println("Encoded dynamic FILLE :::"+encodedbase64DefaultAccessValidity);
    ...
    public static int writeTokenLabourPhoto(TokenPhoto tokenLabourPhoto, com.yafred.asn1.runtime.BERWriter writer) {
    ...
    public static int writeTokenPhoto(TokenPhoto tokenLabourPhoto, com.yafred.asn1.runtime.BERWriter writer) {
        int length = 0;
    ...
    public static int writeTokenDefaultAccess(TokenDefaultAccessValidity tokenDefaultAccess, com.yafred.asn1.runtime.BERWriter writer) {
        int componentLength = 0;
        try {
    ...
    public static int writeTokenDefault(TokenDefaultAccessValidity tokenDefaultAccess, com.yafred.asn1.runtime.BERWriter writer) {
        int length = 0;
    ...
    public static int writeTokenSpecialAccess(TokenSpecialAccessPermission tokenSpecialAccess, com.yafred.asn1.runtime.BERWriter writer) {
        int componentLength = 0;
        try {
    ...
    public static int writeSpecialDefault(TokenSpecialAccessPermission tokenSpecialAccess, com.yafred.asn1.runtime.BERWriter writer) {
        int length = 0;
...
//        dynamicFile.setLabourId(labourDetails.getLabourId());
    ...
    public static int writeTokenDynamicFile(DynamicFile pdu, com.yafred.asn1.runtime.BERWriter writer) {
        int componentLength = 0;
        try {
    ...
    public static int writeTokenDynamic(DynamicFile instance, com.yafred.asn1.runtime.BERWriter writer) {
        int length = 0;
    ...
    public static int writeFingerPrint(TokenFingerPrint tokenFingerPrint, com.yafred.asn1.runtime.BERWriter writer) {
        int componentLength = 0;
        try {
    ...
    public static int writeFingerPrintDefault(TokenFingerPrint tokenFingerPrint, com.yafred.asn1.runtime.BERWriter writer) {
        int length = 0;
    ...
    public static int writeSignature1(TokenSignature1 tokenSign1, com.yafred.asn1.runtime.BERWriter writer) {
        int componentLength = 0;
        try {
    ...
    public static int writeSignature1Default(TokenSignature1 tokenSign1, com.yafred.asn1.runtime.BERWriter writer) {
        int length = 0;
    ...
    public static int writeSignature3(TokenSignature3 tokenSign3, com.yafred.asn1.runtime.BERWriter writer) {
        int componentLength = 0;
        try {
    ...
    public static int writeSignature3Default(TokenSignature3 tokenSign3, com.yafred.asn1.runtime.BERWriter writer) {
        int length = 0;
